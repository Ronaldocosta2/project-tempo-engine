...
-- Update existing projects to have a null user_id (they will need to be reassigned or deleted)
...
-- Add user_id to other related tables via project_id relationship
-- These tables are already protected through their project_id foreign key
-- No direct user_id needed as they inherit access through projects