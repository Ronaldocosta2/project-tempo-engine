  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      <div className="container py-8 px-8 space-y-6">
        ...
        <Tabs defaultValue="simple-list" className="space-y-4">
          <TabsList>
          ...
          <TabsContent value="simple-list" className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-foreground">Lista de Tarefas Simplificada</h2>
            </div>
            <SimpleTaskTable
              tasks={tasks}
